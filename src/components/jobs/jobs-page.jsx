  ...
  <SelectContent>
    ...
    <SelectItem value="product">Product</SelectItem>
     ...
     <div className="relative   rounded-md border border-input ">
        ...
        <Search className="absolute rounded-md left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground" />
  <input 
        type="text"
...
<h2 className="font-bold text-lg">{job.title}</h2>
 ...
 <Link
  href={`/jobs/${job.id}`}
  className="block w-full text-center bg-black py-2 text-white rounded-lg font-semibold hover:opacity-90"
>
  View Details
</Link>
